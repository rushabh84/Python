...
def parse_soup():
    print()
    urlabs = list()  #list created to store only the unique urls
...
def parse_all(a):
    ...
    for elements in a:
        ...
        current_abstract = p[1].text  #there are 3 pairs of <p></p> tags but the 2nd pair which will be at index 1 has abstract as text
