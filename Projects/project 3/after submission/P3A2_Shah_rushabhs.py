...
#             humidity and temperature are calculated. Also, the 2 data frames are grouped by Date and and fir each group calculates the average humidity and temperature(per day average)
...
def user_time_period(a,b):
    ...
    #if you just enter MM-DD-YYY then it wont raise an exception and by default take 00:00:00 as the tim
    while right_input == 0:
        try:
