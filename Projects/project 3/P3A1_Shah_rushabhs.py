...
#             tables and also selects all rows from tables to print the records on the console
import pandas as pd
import sqlite3
...
def main():
    ...
    #please uncomment the below comment if you are runnin the program fr the 2nd time as you will have to drop the tables first
    drop_tables()
    create_tables()
